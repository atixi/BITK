...
"""Verify that starting bitcointk with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcointk with -h for help text")
        ...
        self.log.info("Start bitcointk with -version for version information")
        ...
        self.log.info("Start bitcointkd with -fakearg to make sure it does not start")
