# Support for Output Descriptors in BitcoinTK Core

Since BitcoinTK Core v0.17, there is support for Output Descriptors. This is a
...
on BitcoinTK's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing BitcoinTK Core wallets, a convenience function `combo` is
