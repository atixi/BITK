...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bitcointk-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bitcointk-tx [options] <hex-tx> [commands]  Update hex-encoded bitcointk transaction\n" +
            "or:     bitcointk-tx [options] -create [commands]   Create hex-encoded bitcointk transaction\n" +
            "\n";
