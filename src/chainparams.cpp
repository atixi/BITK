...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 2100000; // Having every 4 years
        ...
        vSeeds.emplace_back("139.180.153.48");
        vSeeds.emplace_back("95.179.135.251");
...
public:
    CTestNetParams() {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,108); // k
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,107); // k
        base58Prefixes[SCRIPT_ADDRESS2] = std::vector<unsigned char>(1,107);// k
